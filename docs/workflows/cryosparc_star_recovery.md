...
Convert particle metadata exported from CryoSPARC into a RELION/JANAS-compatible STAR file, correct the `_rlnImageName` entries generated by CryoSPARC, and, when needed, restore the original source-particle provenance after stack-based processing.
